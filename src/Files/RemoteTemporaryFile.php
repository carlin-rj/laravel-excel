...
class RemoteTemporaryFile extends TemporaryFile
{
	...
	{
		return $this->localTemporaryFile->getDirName();
	}

	public function getFileName(): string
	{
		return $this->localTemporaryFile->getFileName();
	}
    ...
    public function delete(): bool
    {
        ...
        if (!config('mckue-excel.temporary_files.force_resync_remote')) {
